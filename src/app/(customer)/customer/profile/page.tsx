...
import { CheckCircle2, User, Phone, Mail, MapPin, Wallet, CreditCard, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-8 font-sans max-w-5xl mx-auto">
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 font-medium">Manage personal contact info, default delivery coordinates, and customer payment methods.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Main Profile & Customer Payment Method Forms */}
        <div className="lg:col-span-7 space-y-6">
          <Card className="p-6 sm:p-8">
            <h2 className="font-heading text-sm font-bold text-slate-800 mb-4 flex items-center gap-2">
              <User className="w-4 h-4 text-primary-600" /> Account Details
            </h2>
          ...
          {/* Customer's Own Payment Method Card */}
          <Card className="p-6 sm:p-8">
            ...
            <p className="text-xs text-slate-500 font-medium mb-4">Set your default payment method and account info for fast order checkout and Paluwagan remittances.</p>
            ...
            <form onSubmit={handleSavePaymentMethod} className="space-y-4">
              ...
              <div className="pt-2">
                <Button type="submit" variant="secondary">Save Payment Method</Button>
              </div>
            </form>
          </Card>
        </div>

        {/* Right Sidebar: Farm Receiver Payment Channels */}
            ...
            <div className="space-y-3.5 text-xs font-medium text-slate-500">
              ...
              <div className="p-3 bg-amber-50/70 border border-amber-100 rounded-xl text-[11px] text-amber-800 font-medium space-y-1">
                <div className="font-bold flex items-center gap-1.5 text-amber-900">
                  <ShieldCheck className="w-3.5 h-3.5 text-amber-600" /> Payment Remittance Note
                </div>
                <p className="leading-relaxed text-[10px]">
                  Always keep your transaction screenshot or reference number when sending payments to our farm channels.
                </p>
              </div>
            </div>
          </Card>
